 ...
 */
package org.sonatype.nexus.plugins.labrat2.internal.util;
...
public class Labrat2PathUtilsTest
    extends TestSupport
{
  private Labrat2PathUtils underTest;
  ...
  @Before
  public void setUp() {
    underTest = new Labrat2PathUtils();
  ...
  public void buildAssetPath() {
    String result = underTest.buildAssetPath(state, Labrat2PathUtils.PACKAGE_FILENAME);
